...
// import TradeHistory from "./overlays/TradeHistory.vue"
...
import PositionTool from "./overlays/PositionTool.vue";
import InsiderTrades from "./overlays/InsiderTrades.vue";
import Watermark from "./overlays/Watermark.vue";
import Earnings from "./overlays/Earnings.vue";
import SilentPeriod from "./overlays/SilentPeriod.vue";
// import Compare from "./overlays/Compare.vue";
import Journal from "./overlays/Journal.vue";
import InsiderDot from "./overlays/InsiderDot.vue";
import TextChart from "./overlays/TextChart.vue";
import News from "./overlays/News.vue";
import PortfolioTransactions from "./overlays/PortfolioTransactions.vue";
...
export default {
    ...
    created() {
        ...
        this._list = [
            ...
            Candles, Volume, Splitters, LineTool, RangeTool , InsiderTrades,
            Watermark,
            Earnings,
            SilentPeriod,
            PositionTool,
        ...
        this._list.forEach((x, i) => {
            ...
            if (x.methods.tool) {
                tools.push({use_for, info: x.methods.tool()})
            }
