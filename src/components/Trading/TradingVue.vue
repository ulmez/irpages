<template>
    ...
    <div class="trading-vue" v-bind:id="id"
        ...
        <!-- <toolbar v-if="toolbar && $props.leftToolbar"
            ref="toolbar"
        ...
        <!-- <data-toolbar
            v-if="toolbar"
            v-on:chnDateFilter="chnDateFilter"
...
export default {
    name: 'TradingVue',
    components: {
        Chart, Toolbar, Widgets,DataToolbar
    },
    mixins: [ XControl ],
    props: {
        legendView: {
    ...
    computed: {
        ...
        chart_props() {
            let offset = this.$props.toolbar && this.$props.leftToolbar ?
            ...
            let chart_props = {
                ...
                toolbar: (this.$props.toolbar && this.$props.leftToolbar),
    ...
    methods: {
        ...
        chnInterval(interval) {
            ...
            this.$emit("chnInterval", interval);
        },
        ...
        chnDateFilter(t1, t2) {
            if (this.$refs.chart === undefined) {
                var waitingChart = setInterval(() => {
                    if (this.$refs.chart !== undefined) {
                        this.setRange(t1, t2);
                        clearInterval(waitingChart);
                    }
                }, 500);
            } else this.setRange(t1, t2);
        },
        goto(t) {
